                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown action-opt">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                <li>
                                                    <a class="dropdown-item" href="" data-bs-toggle="offcanvas"
                                                        data-bs-target="#edit{{ $item->id_alat }}"
                                                ...
                                                <li>
                                                    <a class="dropdown-item" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModal{{ $item->id_alat }}">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModal{{ $item->id_alat }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Apakah Anda Ingin Menghapus alat
                                                            <strong>{{ $item->nama_alat }}</strong>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-bs-dismiss="modal">Close</button>
                                                            <a href="/hapus/{{ $item->id_alat }}/alat "
                                        ...
                                        <div class="offcanvas offcanvas-end" tabindex="-1" id="edit{{ $item->id_alat }}"
                                            ...
                                            <div class="offcanvas-body p-4">
                                                <form action="/edit/{{ $item->id_alat }}/alat" method="POST">
                                                    @csrf
                                                    <div class="form-group mb-4">
                                                        <label class="label">Name alat</label>
                                                        <input type="text" name="alat" class="form-control text-dark"
                                                            placeholder="User Name"
                                                            value="{{ old('nama_alat', $item->nama_alat) }}">
                                                    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body p-4">
            <form method="POST">
                ...
                <div class="form-group mb-4">
                    <label class="label">Name alat</label>
                    <input type="text" name="alat" class="form-control text-dark" placeholder="User Name">
                </div>
                <div class="form-group d-flex gap-3">
