    ...
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                <form action="/tambah_operator" method="POST">
                    @csrf
                    <div class="row mb-4">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" name="name" class="form-control text-dark ps-5" placeholder="Masukkan Nama">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" name="email" class="form-control text-dark ps-5" placeholder="Masukkan NIS">
                    ...
                    <div class="row mb-4 justify-content-center">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="password" name="password" class="form-control ps-5" aria-label="Tanggal Lahir">
