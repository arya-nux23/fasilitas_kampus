                ...
                <div class="table-responsive">
                    <table class="table align-middle" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group gap-1">
                                        <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#detailPeminjam{{ $item->id_peminjam }}" title="Lihat">
                                            <i class="ri-eye-line"></i>
                                        </button>
                                        @if ($item->status_pengajuan !== 'pending' && !$item->returned_at)
                                            <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#KembaliModal{{ $item->id_peminjam }}" title="Ajukan">
                                                <i class="ri-checkbox-circle-line"></i>
                                            </button>
                                        @endif
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $item->id_peminjam }}" title="Edit">
                                            ...
                                            <form method="POST" action="/edit/peminjam/{{ $item->id_peminjam }}/mahasiswa">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="barang_id" name="barang" required>
                                                        ...
                                                        @foreach ($barang as $b)
                                                            <option value="{{ $b->id_barang }}" {{ $item->barang_id == $b->id_barang ? 'selected' : '' }}>
                                                                {{ $b->nama_barang }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" name="date" value="{{ $item->date }}" class="form-control" id="tanggal">
                                                </div>
                            ...
                            <!-- Modal Detail -->
                            <div class="modal fade" id="detailPeminjam{{ $item->id_peminjam }}" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" value="{{ $item->mahasiswa->nama_mhs }}" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Jurusan</label>
                                                        <input class="form-control" value="{{ $item->mahasiswa->jurusan->nama_jurusan ?? '-' }}" disabled>
                                                    </div>
                                                    <div class="text-center">
                                                        <label class="form-label">Foto Barang</label>
                                                        @if ($item->barang && $item->barang->foto)
                                                            <img src="{{ asset('storage/' . $item->barang->foto) }}" class="img-fluid rounded shadow" style="max-height: 300px; object-fit: cover;">
                                                        @else
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" value="{{ optional($item->barang)->nama_barang ?? '-' }}" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Stok</label>
                                                        <input class="form-control" value="{{ optional($item->barang)->stok ?? '-' }}" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" value="{{ $item->status_pengajuan }}" disabled>
                                                    </div>
                                                    <div class="mb-3">
